...
namespace V2RayW
{
    public partial class MainForm : Form
    {
        ...
        public void updateMenu()
        {
            ...
            //serverMenuItems.Add(new ToolStripMenuItem("use all", null, switchToServer));
            ...
            {
                if (Program.selectedServerIndex < serverMenuItems.Count())
            ...
            //{
            //    var tmp = new ToolStripMenuItem("use all", null, switchToServer);
            //    if (Program.useMultipleServer)
            //        tmp.Checked = true;
            //    serversToolStripMenuItem.DropDownItems.Add(tmp);
            //}
        ...
        private void switchToServer(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show("selected " + Program.selectedServerIndex, "Main");
